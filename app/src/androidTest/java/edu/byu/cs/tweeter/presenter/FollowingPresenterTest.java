...
public class FollowingPresenterTest {
    ...
    public void setup() {
        ...
        Mockito.when(followingServiceSpy.getServerFacade()).thenReturn(serverFacadeSpy);
        Mockito.when(followingPresenterSpy.getFollowingService()).thenReturn(followingServiceSpy);
